...
item_row_t item_table[] = {
    ...
    [0x0077] = ITEM_ROW(0x53,       BROWN_CHEST, 0x98, -1, 0x0090, 0x00C7, 0x95, no_upgrade, no_effect, -1, -1, NULL), // Deku Stick Upgrade (20)
    [0x0078] = ITEM_ROW(0x53,       BROWN_CHEST, 0x99, -1, 0x0091, 0x00C7, 0x95, no_upgrade, no_effect, -1, -1, NULL), // Deku Stick Upgrade (30)
    [0x0079] = ITEM_ROW(0x53,       BROWN_CHEST, 0x9A, -1, 0x00A7, 0x00BB, 0x96, no_upgrade, no_effect, -1, -1, NULL), // Deku Nut Upgrade (30)
    [0x007A] = ITEM_ROW(0x53,       BROWN_CHEST, 0x9B, -1, 0x00A8, 0x00BB, 0x96, no_upgrade, no_effect, -1, -1, NULL), // Deku Nut Upgrade (40)
    ...
    [0x0087] = ITEM_ROW(  -1,       BROWN_CHEST,   -1, -1,    -1, 0x00BB, 0x96, nut_upgrade,       no_effect, -1, -1, NULL), // Progressive Nut Capacity
    [0x0088] = ITEM_ROW(  -1,       BROWN_CHEST,   -1, -1,    -1, 0x00C7, 0x95, stick_upgrade,     no_effect, -1, -1, NULL), // Progressive Stick Capacity
