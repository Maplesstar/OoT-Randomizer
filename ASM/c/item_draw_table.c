...
item_draw_table_entry_t item_draw_table[] = {
    ...
    [0x1D] = { draw_gi_opa_with_flame,      { 0x06000580, 0xe0d4ffFF, 0xd4ffe2FF } }, // Small Magic Jar
    [0x1E] = { draw_gi_opa_with_flame,      { 0x06000EE0, 0xe0d4ffFF, 0xd4ffe2FF } }, // Large Magic Jar
    ...
    [0x94] = { draw_gi_opa_with_flame,      { 0x060004D0, 0xe0d4ffFF, 0xd4ffe2FF } }, // Deku Stick
    [0x95] = { draw_gi_deku_nut_with_flame, { 0x06000E90, 0xe0d4ffFF, 0xd4ffe2FF } }, // Deku Nut
};
